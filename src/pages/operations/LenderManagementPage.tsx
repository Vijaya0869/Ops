...
const LenderManagementPage = () => {
  ...
  const handleDownload = () => {
    const reportContent = `Lender Management Report - ${timePeriod}
==========================================

Generated on: ${new Date().toLocaleDateString()}
Time Period: ${timePeriod}

This report includes all lender management metrics and performance data.
`;
    const blob = new Blob([reportContent], { type: 'text/plain' });
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a');
    a.href = url;
    a.download = `lender-management-report-${timePeriod}-${Date.now()}.txt`;
    a.click();
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="mb-6 flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">Lending relationships and loan portfolio management</p>
            </div>
